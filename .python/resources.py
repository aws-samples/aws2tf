...
def resource_types(type):
    ...
    elif type == "autoscaling": rets=["aws_autoscaling_group"]; return rets # Autoscaling Group
    ...
    elif type == "cloudfront": rets=["aws_cloudfront_distribution"]; return rets # Cloudfront Distribution

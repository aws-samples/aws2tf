...
def getstackresources(stack_name,client):
    ...
    with open('stack-unprocessed.log', 'a') as f:
        for j in response:
            ...
            elif type == "AWS::ACMPCA::CertificateAuthority": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ACMPCA::CertificateAuthorityActivation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ACMPCA::Permission": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::AccessAnalyzer::Analyzer": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::AmazonMQ::Broker": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::AmazonMQ::Configuration": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::AmazonMQ::ConfigurationAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Amplify::App": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Amplify::Branch": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::ApiGateway::ApiKey": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::Authorizer": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::BasePathMapping": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::ClientCertificate": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::Deployment": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::ApiGateway::DomainName": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::GatewayResponse": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::Method": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::Model": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::RequestValidator": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::Stage": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::UsagePlan": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::UsagePlanKey": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGateway::VpcLink": common.call_resource("aws_apigatewayv2_vpc_link", pid)
            elif type == "AWS::ApiGatewayV2::Api": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::ApiGatewayManagedOverrides": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::ApiMapping": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::Authorizer": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::Deployment": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::DomainName": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::Integration": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::IntegrationResponse": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::Model": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::Route": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::RouteResponse": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::Stage": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::ApiGatewayV2::VpcLink": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::AppMesh::GatewayRoute": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::AppMesh::Route": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Athena::DataCatalog": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Athena::PreparedStatement": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::CloudFormation::CustomResource": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::CloudFront::OriginRequestPolicy": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::CodeBuild::Project": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Config::ConfigRule": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Config::ConfigurationAggregator": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Config::ConfigurationRecorder": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Config::ConformancePack": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Config::DeliveryChannel": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Connect::ContactFlow": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Connect::HoursOfOperation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Connect::Instance": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Connect::InstanceStorageConfig": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Connect::IntegrationAssociation": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Connect::PhoneNumber": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Connect::Queue": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Connect::QuickConnect": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::Connect::RoutingProfile": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Connect::SecurityProfile": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::Connect::User": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::DMS::ReplicationInstance": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::DMS::ReplicationSubnetGroup": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::DocDB::DBCluster": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::DocDB::DBClusterParameterGroup": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::DocDB::DBInstance": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::DocDB::DBSubnetGroup": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::EC2::SecurityGroupEgress": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::EC2::Volume": common.call_resource("aws_null", type+" "+pid)
            ...
            elif type == "AWS::MSK::ServerlessCluster": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::MSK::VpcConnection": common.call_resource("aws_null", type+" "+pid)
            elif type == "AWS::MWAA::Environment": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::NetworkFirewall::Firewall": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::NetworkFirewall::FirewallPolicy": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::NetworkFirewall::LoggingConfiguration": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::NetworkFirewall::RuleGroup": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::Pipes::Pipe": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::SSM::Association": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::SageMaker::CodeRepository": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::SageMaker::Endpoint": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::SageMaker::Model": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::SageMaker::NotebookInstanceLifecycleConfig": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::SageMaker::Pipeline": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::SageMaker::Project": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::SageMaker::Space": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::SageMaker::Workteam": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::SecretsManager::ResourcePolicy": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::SecretsManager::RotationSchedule": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::ServiceDiscovery::HttpNamespace": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::StepFunctions::Activity": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::StepFunctions::StateMachineAlias": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::VpcLattice::AccessLogSubscription": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::AuthPolicy": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::Listener": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::ResourcePolicy": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::Rule": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::Service": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::ServiceNetwork": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::ServiceNetworkServiceAssociation": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::ServiceNetworkVpcAssociation": common.call_resource("aws_null", type+" "+pid)
			elif type == "AWS::VpcLattice::TargetGroup": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::WAFv2::IPSet": common.call_resource("aws_null", type+" "+pid)
			...
			elif type == "AWS::WAFv2::WebACL": common.call_resource("aws_null", type+" "+pid)

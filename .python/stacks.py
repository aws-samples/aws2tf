...
def getstackresources(stack_name,client):
    ...
    with open('stack-unprocessed.log', 'a') as f:
        for j in response:
            ...
            elif type == "AWS::ApiGateway::RestApi": common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::AppMesh::Mesh":  common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::Athena::NamedQuery":  common.call_resource("aws_null", pid) 
            elif type == "AWS::Athena::WorkGroup":  common.call_resource("aws_null", pid) 

            elif type == "AWS::AutoScaling::AutoScalingGroup":  common.call_resource("aws_null", pid) 
            elif type == "AWS::AutoScaling::LaunchConfiguration":  common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::Cloud9::EnvironmentEC2":  common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::EC2::NetworkAcl":            common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::EC2::LaunchTemplate":        common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::EC2::VPCEndpoint":           common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::EC2::VPCEndpointService":        common.call_resource("aws_null", pid) 
            elif type == "AWS::EC2::FlowLog":                   common.call_resource("aws_null", pid) 

            elif type == "AWS::ECR::Repository": common.call_resource("aws_null", pid) 

            elif type == "AWS::ECS::Cluster":  common.call_resource("aws_null", pid) 
            elif type == "AWS::ECS::Service":  common.call_resource("aws_null", parn) 
            elif type == "AWS::ECS::TaskDefinition":  common.call_resource("aws_null", pid) 

            elif type == "AWS::EFS::FileSystem":  common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::ElasticLoadBalancingV2::LoadBalancer":  common.call_resource("aws_null", parn) 
            elif type == "AWS::ElasticLoadBalancingV2::Listener":  common.call_resource("aws_null", parn) 
            elif type == "AWS::ElasticLoadBalancingV2::ListenerRule":  common.call_resource("aws_null", parn) 
            elif type == "AWS::ElasticLoadBalancingV2::TargetGroup":  common.call_resource("aws_null", parn) 

            elif type == "AWS::EMR::Cluster":  common.call_resource("aws_null", pid) 
            elif type == "AWS::EMR::SecurityConfiguration": common.call_resource("aws_null", pid) 

            elif type == "AWS::Events::EventBus": common.call_resource("aws_null", pid) 
            elif type == "AWS::Events::Rule": common.call_resource("aws_null", pid)

            elif type == "AWS::Glue::Connection": common.call_resource("aws_null", pid)
            elif type == "AWS::Glue::Crawler": common.call_resource("aws_null", pid)
            elif type == "AWS::Glue::Database": common.call_resource("aws_null", pid)
            elif type == "AWS::Glue::Job": common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::IAM::ManagedPolicy":  common.call_resource("aws_null", parn) 
            elif type == "AWS::IAM::InstanceProfile":  common.call_resource("aws_null", pid) 
            elif type == "AWS::IAM::User":  common.call_resource("aws_null", pid) 
            elif type == "AWS::IAM::AccessKey": common.call_resource("aws_null", pid) 
            elif type == "AWS::IAM::ServiceLinkedRole":  common.call_resource("aws_null", pid) 
            elif type == "AWS::IAM::Group":  common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::KinesisFirehose::DeliveryStream":  common.call_resource("aws_null", pid) 

            elif type == "AWS::KMS::Key":  common.call_resource("aws_null", pid) 
            elif type == "AWS::KMS::Alias": f3.write(type+" "+pid+"  fetched as part of function..'")  # fetched as part of function

            elif type == "AWS::LakeFormation::DataLakeSettings":  common.call_resource("aws_null", pid) 
            elif type == "AWS::LakeFormation::Resource": common.call_resource("aws_null", pid) 
            # pid pard can be json structures for this one
            elif type == "AWS::LakeFormation::Permissions":  common.call_resource("aws_null", pid) 
            elif type == "AWS::LakeFormation::PrincipalPermissions":  common.call_resource("aws_null", lrid) 

            elif type == "AWS::Lambda::Function":  common.call_resource("aws_null", pid) 
            elif type == "AWS::Lambda::LayerVersion":  common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::Logs::LogGroup": common.call_resource("aws_null", parn) 

            elif type == "AWS::RDS::DBCluster": common.call_resource("aws_null", pid)

            elif type == "AWS::RDS::DBSubnetGroup": common.call_resource("aws_null", pid) 
            elif type == "AWS::RDS::DBInstance": common.call_resource("aws_null", pid)  # 601-get-rds-ins.sh & 614-get-rds-cluster-aurora-ins.sh
                
            elif type == "AWS::RDS::DBParameterGroup":  common.call_resource("aws_null", pid) 
            elif type == "AWS::RDS::EventSubscription":  common.call_resource("aws_null", pid) 
            elif type == "AWS::RDS::DBClusterParameterGroup": common.call_resource("aws_null", pid) 

            elif type == "AWS::Redshift::Cluster":  common.call_resource("aws_null", pid) 
            elif type == "AWS::Redshift::ClusterSubnetGroup":  common.call_resource("aws_null", pid) 
            ...
            elif type == "AWS::SageMaker::AppImageConfig":  common.call_resource("aws_null", pid) 
            elif type == "AWS::SageMaker::Domain":  common.call_resource("aws_null", parn) 
            elif type == "AWS::SageMaker::Image":  common.call_resource("aws_null", pid) 
            elif type == "AWS::SageMaker::ImageVersion": f3.write(type+" "+pid+"  as part of SageMaker Image..'")  # fetched as part of function
            elif type == "AWS::SageMaker::NotebookInstance":  common.call_resource("aws_null", pid) 
            elif type == "AWS::SageMaker::UserProfile": common.call_resource("aws_null", pid)

            elif type == "AWS::SNS::Subscription":  common.call_resource("aws_null", parn) 
            elif type == "AWS::SNS::Topic":  common.call_resource("aws_null", parn) 
            elif type == "AWS::SNS::TopicPolicy":  common.call_resource("aws_null", parn) 
            elif type == "AWS::SQS::Queue":  common.call_resource("aws_null", parn) 
            elif type == "AWS::SQS::QueuePolicy": f3.write(type+" "+pid+"  as part of SQS Queue ..\n") 

            elif type == "AWS::SSM::Parameter":  common.call_resource("aws_null", pid) 
            elif type == "AWS::ServiceDiscovery::PrivateDnsNamespace": f3.write(type+" "+pid+"  as part srv discovery ? ..\n") 
            elif type == "AWS::StepFunctions::StateMachine":  common.call_resource("aws_null", pid) 
            #elif type == "AWS::SecretsManager::SecretTargetAttachment ;;
            elif type == "AWS::SecretsManager::Secret": common.call_resource("aws_null", parn) 
            elif type == "AWS::ServiceDiscovery::Service": common.call_resource("aws_null", pid) 

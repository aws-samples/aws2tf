...
**August 2024 - Try the new Python version!**

This bash version of aws2tf is now depreciated - please use the Python version instead
...
+ AWS cli (v2) **version 2.15.0 or higher** needs to be installed and you need a login with at least "Read" privileges.
+ terraform **version v1.7.5** or higher needs to be installed.

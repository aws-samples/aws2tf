...
def resource_types(type):
    ...
    elif type == "iam": rets=["aws_iam_role","aws_iam_policy"]; return rets # IAM Roles
    ...
    elif type == "redshift": rets=["aws_redshift_cluster","aws_redshiftserverless_workgroup"]; return rets # Redshift
